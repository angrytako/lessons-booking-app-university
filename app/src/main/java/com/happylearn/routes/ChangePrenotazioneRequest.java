...
//    private Prenotazione updatedPrenotazione;
//    private RecyclerView miePrenotazioni;
//    public ChangePrenotazioneRequest(Context context, Activity activity, Prenotazione updatedPrenotazione, RecyclerView miePrenotazioni) {
//        this.context = context;
//        this.activity = activity;
//        this.updatedPrenotazione = updatedPrenotazione;
...
//        Call<SimpleMessage> call = gerritAPI.changePrenotazione(updatedPrenotazione);
//        call.enqueue(this);
//
//
//    }
...
//
//            ((HappyLearnApplication)activity.getApplication()).setBookings(message);
